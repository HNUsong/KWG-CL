...
**An Efficient Multimodal Fusion and Multi-Objective Grasping Model Combining Automated Data Collection and Continual Learning for Kitchen Waste Sorting**,  
by Songyun Deng, Yaoxin Lai, Li Zhou, Ruiyuan Pei, Hai Qin, Shao Xiang, Wei Sun, Qiaokang Liang, and Dan Zhang

which is in **the stage of submission**.
# Introduction
...
# Attention!
Since our paper related to this dataset is currently in the submission process and as the dataset is being utilized for further experiments, we are temporarily releasing only a part of the dataset.
# License
